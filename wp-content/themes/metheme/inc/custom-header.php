...
add_action( 'after_setup_theme', 'metheme_custom_header_setup' );

if ( ! function_exists( 'metheme_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see metheme_custom_header_setup().
 */
function metheme_header_style() {
